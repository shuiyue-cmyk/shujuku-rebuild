...
import { getMergedRacePhysiologyProfile } from '../../src/service/biotracker/vendor/race_config.js';
...
test('<bs_race> 块内精子/胎儿路径注入被消毒（安全审查 P2 补全）', async () => {
  const { buildRacePhysiologyPrompt } = await import('../../src/service/biotracker/vendor/race_prompt_context.js');
