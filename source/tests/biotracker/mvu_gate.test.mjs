...
} from '../../src/service/biotracker/vendor/tracker.js';
import { buildSignature } from '../../src/service/biotracker/vendor/state.js';
...
test('mainflow 状态 JSON 转义闭合标签与换行（安全审查 P1 注入防线）', async () => {
  const { buildMainFlowStatePrompt } = await import('../../src/service/biotracker/vendor/tracker_prompt_context.js');
